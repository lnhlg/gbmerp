...
func (*Registry_NacosServer) Descriptor() ([]byte, []int) {
	return file_app_user_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}
...
func (*Registry_NacosClient) Descriptor() ([]byte, []int) {
	return file_app_user_internal_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}
...
var file_app_user_internal_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_app_user_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_user_internal_conf_conf_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
